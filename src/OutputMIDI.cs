...
namespace Quad64.src
{
    ...
    internal class OutputMIDI
    {
        ...
        {
            BinaryStream br = new BinaryStream(new MemoryStream(seq.data));
        ...
        void ParseSequence(BinaryStream br)
        {
            seqTimestamp = 0;
        ...
        void ParseChannel(BinaryStream br, int channel)
        {
        ...
        void ParseLayer(BinaryStream br, int channel, int layer, TimedObjectsManager<TimedEvent> tom)
        {
            layerTimestamp = 0;
        ...
        ushort ReadParameter(BinaryStream br)
        {
